...
//			Integer deptId = (Integer) map.get(SecurityConstants.DETAILS_DEPT_ID);
            ...
            Integer id = Integer.parseInt(String.valueOf(map.get(SecurityConstants.DETAILS_USER_ID)));
            Integer deptId = Integer.parseInt(String.valueOf(map.get(SecurityConstants.DETAILS_DEPT_ID)));

            PigUser user = new PigUser(id, deptId, username, N_A, new CommunistUserInfo(),true
